...
//                Intent i = new Intent(MainActivityChat.this, LoginActivity.class);
...
//        });
        ...
        addGroupBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final EditText txtUrl = new EditText(MainActivityChat.this);
                // Set the default text to a link of the Queen
                txtUrl.setHint("Group Name");
                new AlertDialog.Builder(MainActivityChat.this)
